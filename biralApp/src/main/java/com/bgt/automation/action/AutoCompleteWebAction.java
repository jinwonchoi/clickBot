...
public class AutoCompleteWebAction extends BaseAction {

	static Logger Log = Logger.getLogger(AutoCompleteWebAction.class);

	public AutoCompleteWebAction(ActionItem item)
			throws Exception {
		super(item);
